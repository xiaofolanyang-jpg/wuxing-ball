...
window.CHAPTER5 = { events: [
  ...
  // ===== 事件2：第一轮·主场（比赛·6节点） =====
  {
    ...
    result: {
      ...
      win:     { text: "赢了，{lastScore}，干净。{companion1Name}进了一个，你助攻了一个。", effects: { reputation: 3, assists: 1 } },
      draw:    { text: "平了，{lastScore}。主场，不够好。看台上有人提前走了。", effects: { reputation: 1 } },
      lose:    { text: "输了。主场，{lastScore}。看台上安静了。你站在场中央，耳朵里全是自己的心跳。", effects: { demonValue: 3 } }
    },
    next: "ch5_away"
  },
  ...
  // ===== 事件9：升级附加赛（比赛·BOSS战） =====
  {
    ...
    result: {
      ...
      win:     { text: "赢了！{lastScore}，绝杀！升级了，B级！{companion1Name}冲过来把你扑倒。两百个人在吼。", effects: { reputation: 15, flags: { promoted: true } } },
