...
window.CHAPTER14 = { events: [
  ...
  { id: "ch14_match", chapter: 14, type: "match",
    ...
    result: {
      bigwin: { text: "【灵光一闪】你的领域，展开了。天人合一，你突破了。他的领域，碎了。球进了。世界安静了。然后——轰。五万人。", effects: { reputation: 50, goals: 1, allAttrsFlat: 4, flags: { assemblyChampion: true, wuxingChamp: true, tianrenBreakthrough: true } } },
      win: { text: "你冲了，他挡了，你变了向，他——吃了。你过了，射了，进了。{lastScore}。你跪在地上，五万人在喊。", effects: { reputation: 30, goals: 1, flags: { assemblyChampion: true, wuxingChamp: true } } },
      draw: { text: "终场，{lastScore}。加时，没人进球。点球。", effects: { stamina: -10 } },
      lose: { text: "终场，{lastScore}。他的领域，你没能破。你跪在地上，五万人在喊他的名字。", effects: { demonValue: 10, reputation: 15 } }
    },
    next: "ch14_gate" },
