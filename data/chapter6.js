...
window.CHAPTER6 = { events: [
  ...
  // ===== 事件3：比赛·碾压（match·高难度） =====
  {
    ...
    result: {
      ...
      win:     { text: "你赢了，{lastScore}。沈惊寒进了一个，但你进了两个。哨响的时候，他看了你一眼。这次，不是一眼就移开了。", effects: { reputation: 10, flags: { rivalUpset: true } } },
      draw:    { text: "平了，{lastScore}。沈惊寒进了一个，你也进了一个。不算赢，但你没被碾。", effects: { reputation: 5 } },
      lose:    { text: "{lastScore}，碾压。沈惊寒一个人过了你三次，进了两个。第二个，他从中场开始带球，过了四个人，包括你。你连他的衣角都没碰到。哨响的时候，你站在场中央，腿在抖。不是累的，是恐惧。", effects: { demonValue: 8, reputation: -2, flags: { rivalCrushed: true } } }
    },
    next: "ch6_locker"
  },
  ...
  // ===== 事件6：第二次相遇（match·差距缩小） =====
  {
    ...
    result: {
      ...
      win:     { text: "你赢了，{lastScore}。你过了他一次。一次，他愣了。你看到了，他愣了。", effects: { reputation: 8, flags: { rivalGapClosing: true } } },
      draw:    { text: "平了，{lastScore}。你过了他一次，他愣了。你看到了，差距在缩小。", effects: { reputation: 5, flags: { rivalGapClosing: true } } },
      lose:    { text: "输了，{lastScore}，但只输了一个。而且——你过了他一次。一次，他愣了。你看到了，他愣了。", effects: { reputation: 5, flags: { rivalGapClosing: true } } }
    },
    next: "ch6_gaze"
  },
