...
window.CHAPTER13 = { events: [
  ...
  { id: "ch13_rival", chapter: 13,
    text: ["通道里。","沈惊寒站在你旁边，国家队队服。你们一起穿了快一个月了。","但今天不一样，今天是淘汰赛，输了就回家。","他看着前方，没看你。","「第一次。」他说。","「什么？」","「一起踢正式比赛。」","你笑了。「训练赛不算？」","「不算。」","哨声快响了，他终于转头看了你一眼。「别拖后腿。」","「你也是。」"],
    effects: { bonds: { sudi: 5 } },
    next: "ch13_knockout" },
  ...
  { id: "ch13_knockout", chapter: 13, type: "match",
    ...
    result: {
      ...
      lose: { text: "输了，{lastScore}。你被过了，化域的压，你喘不过气。结束了。", effects: { demonValue: 5, reputation: 10 } }
    },
    next: "ch13_after" },
  ...
  { id: "ch13_semi", chapter: 13, type: "match",
    ...
    result: {
      bigwin: { text: "你的领域，展开了。不是化域的领域，是——天人合一的边缘。球进了，{lastScore}。", effects: { reputation: 30, goals: 1, coreAttrs: 3, flags: { tianrenThreshold: true } } },
      win: { text: "你冲了，他挡了，你变了向，射了，进了。{lastScore}，五万人在喊。", effects: { reputation: 20, goals: 1 } },
      draw: { text: "点球大战。你射了，进了。门将扑了方向，险胜。", effects: { reputation: 12 } },
      lose: { text: "输了，{lastScore}。传奇就是传奇，你被碾了。季军赛。", effects: { reputation: 15, demonValue: 3 } }
    },
