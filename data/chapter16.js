...
window.CHAPTER16 = { events: [
  ...
  { id: "ch16_opening", chapter: 16,
    text: ["{realm}巅峰，89。","差一点，差那一点。","天人合一，90。","你撞了，又撞了，又撞了。","过不去。","「不是撞的。」营主的声音，他来看你了。「是——放的。」","「放什么？」","「放你自己。」","你不懂。"],
    effects: { flags: { peakBottleneck: true } },
    next: "ch16_season" },

  { id: "ch16_season", chapter: 16, type: "match",
    text: ["最后一个赛季。","你踢了，不是为了赢，是为了——踢。","每一场，你都全力以赴，但不是为了比分，是为了——那一脚，那一个瞬间。","四场，{seasonRecord}。你不在乎排名了。"],
    ...
    result: {
      ...
      win: { text: "{seasonRecord}，够了。你不在乎排名，你在乎那一脚。", effects: { reputation: 10, coreAttrs: 2 } },
      draw: { text: "{seasonRecord}，你笑了。无所谓。", effects: { reputation: 5, coreAttrs: 1 } },
      lose: { text: "输了。你不在乎，真的不在乎。", effects: { reputation: 5 } }
    },
    next: "ch16_rival_eve" },

  { id: "ch16_rival_eve", chapter: 16,
    text: ["赛季快结束了。","一封信，沈惊寒的。","「最后一场。我等你。」","你看着那封信，笑了。","六年了，从淬炼营，到五行大会，到天罡。","你们一直在追，一直在斗。","「最后一场。」你说。"],
    effects: { bonds: { sudi: 3 } },
    next: "ch16_rival" },
  ...
  { id: "ch16_leave", chapter: 16,
    text: ["你走了。","没告诉任何人，只留了一张纸条。","「球，我还会踢，只是换个地方。」","你背着包，走在路上。","远处有个小球场，几个孩子在踢球。","你停下来，看了很久。","一个球滚到你脚边。","你捡起来，扔回去。","「谢了！大叔！」","你笑了，继续走。"],
