...
window.CHAPTER11 = { events: [
  ...
  { id: "ch11_opening", chapter: 11,
    text: ["这个赛季，你不一样了。","{realm}境，国家队成员。","你不再是「升班马」，你是——contender。","前五场，{seasonRecord}，排名第一。"],
    system: "【第十一章·传奇·交锋 开启。冠军，传奇，五行大会前的最后考验。】",
    effects: { reputation: 10, matches: 5, wins: 4 },
    next: "ch11_tianwang" },

  { id: "ch11_tianwang", chapter: 11, type: "match",
    text: ["第八场，天王山。","对手排名第二，差你一分。赢了，冠军稳了；输了，一切重来。","两万人全在喊，你听不见，你只听到自己的心跳。"],
    opponent: { name: "天罡·天王山", element: "金", strength: 62 }, teamBase: 40,
    result: {
      bigwin: { text: "大胜，冠军稳了，两万人全在喊你的名字。", effects: { reputation: 15, flags: { titleWon: true } } },
      win: { text: "赢了，{lastScore}，冠军稳了。{companion1Name}把你扑倒。「冠军！我们是冠军！」", effects: { reputation: 12, flags: { titleWon: true } } },
      draw: { text: "平了，{lastScore}，差一点，但还有机会。", effects: { reputation: 8 } },
      lose: { text: "输了，{lastScore}，一切重来。你坐在场边，喘。", effects: { demonValue: 4 } }
    },
  ...
  { id: "ch11_champion", chapter: 11,
    text: ["哨响，冠军。","两万人全在喊。","{companion1Name}把你扑倒，所有人压上来，你被埋在底下。","你笑了，在人群底下，你笑了。"],
  ...
  { id: "ch11_legends", chapter: 11, type: "match",
    ...
    opponent: { name: "五传奇·决赛", element: "火", strength: 70 }, teamBase: 40,
    result: {
      bigwin: { text: "你赢了，五个传奇，你赢了！全场起立，你站在场中央，这是你的人生。", effects: { reputation: 25 } },
      win: { text: "你赢了，{lastScore}。五个传奇，你进了一个，全场起立。", effects: { reputation: 22, goals: 1 } },
      draw: { text: "平了，{lastScore}。你进了一个，在五个传奇面前，全场起立。", effects: { reputation: 20, goals: 1 } },
      lose: { text: "{lastScore}，输了。但你进了一个，在五个传奇面前，全场起立。虽败犹荣。", effects: { reputation: 20, goals: 1 } }
    },
    next: "ch11_peak" },
