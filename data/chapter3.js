...
window.CHAPTER3 = { events: [
  ...
  // ===== 事件6：训练·地狱周（修炼·叙事） =====
  {
    ...
    effects: { coreAttrs: 5, stamina: -20 },
    next: "ch3_awaken"
  },
    ...
    choices: [
      {
        ...
        critical: { text: "【灵光一闪】灵力不是冲过去的。是你带着它走过去的。像呼吸一样自然。你的灵根深了两层。", effects: { coreAttrs: 5, flags: { awakened: true, deepAwaken: true } }, next: "ch3_master_gate" }
      },
      {
  ...
  // ===== 事件11：联赛·前两场（比赛·磨合期） =====
  {
    ...
    chapter: 3,
    text: [
      "第一场。输了。0-2。散沙。五个人各踢各的。",
      "第二场。平了。1-1。好一点了。但还是不行。",
      "{companion1Name}在更衣室里拍了桌子。「你们在踢什么？！」",
      "没人说话。",
      "「明天。」他说。「谁再各踢各的。我铲他。」"
    ],
    effects: { demonValue: 2, matches: 2, reputation: 1, chapter: 1 },
    next: "ch4_opening"
  }
