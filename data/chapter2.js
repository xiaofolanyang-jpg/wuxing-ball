...
window.CHAPTER2 = { events: [
  ...
  // 首秀（比赛，fallback 简化）
  {
    ...
    pool: null,
    fallback_choices: [
      { id: "A", text: "拿球后内切起脚", check: { attrs: ["shooting", "burst"], difficulty: 38, tag: "射门+爆发" },
      ...
      { id: "B", text: "为队友做球", check: { attrs: ["passing", "vision"], difficulty: 36, tag: "传球+视野" },
  ...
  // 替补席煎熬
  {
    ...
    text: [
      ...
      "赵玄在一线队混得风生水起，每场必发。你咬牙加练，把不甘咽进肚里。"
    ],
    choices: [
  ...
  // 正式联赛（使用踢法池）
  {
    ...
    fallback_choices: [
      { id: "A", text: "禁区前沿起脚远射", check: { attrs: ["shooting", "power"], difficulty: 44, tag: "射门+力量" },
      ...
      { id: "B", text: "肋部直塞找前锋", check: { attrs: ["passing", "vision"], difficulty: 40, tag: "传球+视野" },
      ...
      { id: "C", text: "回防协助，先稳后场", check: { attrs: ["tackle", "intercept"], difficulty: 42, tag: "铲断+拦截" },
  ...
  // 天劫·第二关：舆论
  {
    ...
    choices: [
      ...
      { id: "B", text: "沉默以对，用脚说话", effects: { reputation: -2, attrs: { resolve: 1 } }, next: "ch2_trib_3" }
    ]
  },
  ...
  // 结局判定入口
  {
    ...
    text: "赛季落幕。你站在更衣室，窗外是另一片天空。命运的天平，由这一路的声望与抉择，缓缓落下。"
  }
