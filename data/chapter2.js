...
window.CHAPTER2 = { events: [
  ...
  // ===== 事件3：资格赛·第一场（比赛·6节点） =====
  {
    ...
    text: [
      ...
      "这是你第一次踢完整的六节点比赛。",
      "开场。球在你脚下，对方五个人站在对面。没有看台，没有解说，只有风和土腥味。",
      "你深吸一口气。动了。"
    ],
  ...
  // ===== 事件10：挑战者联赛·首战（比赛·6节点） =====
  {
    ...
    opponent: { name: "B级挑战者", element: "金", strength: 38 },
    teamBase: 30,
    result: {
      bigwin: { text: "大胜B级对手。终场哨响，看台上那二十几个人全站起来了。{companion1Name}冲过来把你扑倒。「我就说！」他吼。「我就说能赢！」", effects: { reputation: 10 } },
      win:     { text: "赢了。第一次踢B级，你们赢了。{companion1Name}坐在场边喘，笑了。「下次，」他说，「还赢。」", effects: { reputation: 6 } },
      draw:    { text: "平了。不算好，但也不算坏。第一次，B级对手，你们没输。{companion1Name}坐在场边，喘。「下次。」他说。「赢。」", effects: { reputation: 3 } },
      lose:    { text: "输了。B级就是B级。你们被压着打了大半场。{companion1Name}坐在场边，一句话不说。你坐在他旁边，也不说。风把汗吹凉了。", effects: { reputation: -2, demonValue: 4 } }
    },
