...
window.CHAPTER2 = { events: [
  ...
  // 首秀（比赛，fallback 简化）
  {
    ...
    chapter: 2,
    type: "match",
    text: "首秀。对手是同城中游球队「布澜竞技」二队。你坐在替补席上，屁股底下的塑料椅冰凉的。下半场第三十分钟，教练走过来，手搭你肩上，捏了捏：「上去。让他们记住你。」你站起来，腿有点僵。",
    opponent: { name: "布澜竞技B队", element: "水", strength: 42 },
    pool: null,
    fallback_choices: [
      { id: "A", sit: "attack", text: "拿球，内切，起脚", check: { attrs: ["shooting", "burst"], difficulty: 28, tag: "射门+爆发" },
      ...
      { id: "B", sit: "balanced", text: "为队友做球", check: { attrs: ["passing", "vision"], difficulty: 26, tag: "传球+视野" },
  ...
  // 替补席煎熬
  {
    ...
    text: [
      ...
      "武石在一线队混得风生水起，场场首发。你坐在场边看他进球，看全队围上去。你把水瓶盖拧开又拧上，拧开又拧上。然后起身，去加练。"
    ],
    choices: [
      { id: "A", text: "加练，用汗水换机会", effects: { stamina: -10, attrs: { resolve: 2 }, reputation: 3 }, next: "ch2_league" },
      { id: "B", text: "找教练理论，要出场时间", check: { attrs: ["resolve", "iq"], difficulty: 20, tag: "决断+球商" },
  ...
  // 正式联赛（使用踢法池）
  {
    ...
    fallback_choices: [
      { id: "A", sit: "attack", text: "禁区前沿，抡腿远射", check: { attrs: ["shooting", "power"], difficulty: 34, tag: "射门+力量" },
      ...
      { id: "B", sit: "balanced", text: "肋部直塞，找前锋", check: { attrs: ["passing", "vision"], difficulty: 30, tag: "传球+视野" },
      ...
      { id: "C", sit: "defense", text: "回防协助，先稳后场", check: { attrs: ["tackle", "intercept"], difficulty: 32, tag: "铲断+拦截" },
  ...
  // 天劫·第一关：心志
  {
    ...
    choices: [
      { id: "A", text: "咬牙对抗，决意归来", check: { attrs: ["resolve", "pressure"], difficulty: 28, tag: "决断+抗压" },
  ...
  // 天劫·第二关：舆论
  {
    ...
    choices: [
      { id: "A", text: "召开发布会，正面回应", check: { attrs: ["pressure", "iq"], difficulty: 30, tag: "抗压+球商" },
  ...
  // 天劫·第三关：复出
  {
    ...
    choices: [
      { id: "A", text: "复出即拼命，证明自己", check: { attrs: ["resolve", "burst"], difficulty: 32, tag: "决断+爆发" },
